...
# ocu=0.08,swp=0.09
d5=np.array([1.70,1.42,1.14,1.02,1.0,1.0])
d5_std=np.array([0.48,0.49,0.34,0.14,0.1,0.0])

d10=np.array([1.94,1.82,1.59,1.31,1.26,1.13])
d10_std=np.array([0.39,0.41,0.49 ,0.46,0.44,0.33])
